...
{ source: "John LeFevre (@gselevator)",
  text: "My garbage disposal eats better than 99% of the world." },
{ source: "John LeFevre (@gselevator)",
  text: "The only thing more impressive than my accomplishments is my resume." },
{ source: "John LeFevre (@gselevator)",
  text: "My garbage disposal eats better than 99% of the world." },
{ source: "John LeFevre (@gselevator)",
  text: "Statistically speaking, you shouldn't worry about what your first wife's mother looks like." },
{ source: "John LeFevre (@gselevator)",
  text: "If you can be good at one thing, make it lying, because if you're good at lying, you're good at everything." },
{ source: "@buckforitt on Twitter",
...
{ source: "@Elizabeastan on Twitter",
  text: "Do all video cameras constantly blink a red light when they're turned off? Or is it just this guy's?" },
